        ...
        function displayWeather(cityInput) {
            ...
            $.ajax({
                ...
                $('#daily-weather').append(
                    ...
                    +"<ul class='daily'>" + "Day-Hour: " + weatherResponse.currentConditions.dayhour + "</ul>" 
                    + "<ul class='daily'>" + "Temperature: " + weatherResponse.currentConditions.temp.f + " °F" + "</ul>" 
                    + "<ul class='daily'>" + "Precipitation: " + weatherResponse.currentConditions.precip + "</ul>" 
                ...
                // Heading for seven day forecast
                $('#seven-days').append(
                    "<div class='col-md-12'>" + "<h2>" + "7-Day Forecast:" + "</h2>"
                );
                 // Appending next seven days weather card
                $('#day-1').append(
